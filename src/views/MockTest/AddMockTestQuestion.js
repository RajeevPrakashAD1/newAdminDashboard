				...
				<CCol xs="12" md="11">
					<CCard style={{ backgroundColor: '#fff', padding: '40px' }}>
						<CCardHeader style={{ padding: '0px' }}>
							<h1 style={{ display: 'inline', paddingLeft: '0px' }}>Add Mock Test Question </h1>
							...
							<CCardBody>
								<CRow>
									<CForm onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <InputFile label="Question Image (optional)" name="MockQuestionImage" register={register} />


										<OneMockQuestion control={control} register={register}/>
